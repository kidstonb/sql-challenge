...
SELECT dept_emp.emp_no, dept_emp.emp_no, last_name, first_name, departments.dept_name
FROM dept_emp
...
-- SELECT salary FROM salaries WHERE emp_no IN (SELECT emp_no FROM employees);